		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Produtos",
									"targetURL": "#trainningproduto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainningproduto-display": {
								"semanticObject": "trainningproduto",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trainning.produto",
									"url": sap.ui.require.toUrl("trainning/produto")
								}
							}
						}
					}
